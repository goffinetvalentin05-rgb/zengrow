...
export type PublicRestaurantPageBundle = {
  formProps: Omit<PublicReservationFormProps, "forceLandingExperience" | "previewMode" | "dedicatedReservationPage">;
...
export function buildPublicRestaurantPageProps(loaded: LoadedPublicRestaurant): PublicRestaurantPageBundle {
  ...
  const formProps = {
    ...
    ctaLabel:
      editorConfig.hero.primaryCta.trim() ||
      restaurant.public_cta_label?.trim() ||
      "Réserver une table",

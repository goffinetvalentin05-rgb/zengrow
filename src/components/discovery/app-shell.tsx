        ...
        <div className="relative z-10 flex h-full p-0 md:p-3">
          <div className="flex h-full min-w-0 flex-1 overflow-hidden md:rounded-[1.75rem] md:border md:border-white/[0.06] md:bg-[#0c0c0e]/85">
            ...
            <div className="flex min-h-0 min-w-0 flex-1 flex-col">
              <main
                id="discovery-scroll"
                className="relative min-h-0 flex-1 overflow-x-hidden overflow-y-auto px-0 pb-[var(--sz-nav-pad)] pt-[max(1rem,env(safe-area-inset-top))] md:px-10 md:pb-14 md:pt-8"
              >
                {children}
              </main>
            </div>

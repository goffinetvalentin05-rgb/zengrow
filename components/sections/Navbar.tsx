...
export function Navbar() {
  ...
  const boxShadow = useTransform(
    ...
    [0, 160],
    [
      "0 25px 50px -12px rgb(0 0 0 / 0.4), 0 0 48px rgba(255,90,42,0.12), inset 0 1px 0 rgba(255,255,255,0.06)",
      "0 28px 56px -12px rgb(0 0 0 / 0.55), 0 0 64px rgba(255,90,42,0.22), inset 0 1px 0 rgba(255,255,255,0.08)",
    ],
  );
  ...
  return (
    <header className="pointer-events-none fixed inset-x-0 top-4 z-50 flex justify-center px-3 sm:top-6 sm:px-4">
      ...
      <motion.nav
        ...
        className="relative flex w-full items-center justify-between gap-3 overflow-hidden rounded-full border border-[rgba(255,122,61,0.18)] bg-[rgba(18,11,7,0.78)] px-4 py-2.5 shadow-2xl backdrop-blur-xl sm:gap-5 sm:px-6 sm:py-3"
      >
        <span className="landing-navbar-shine" aria-hidden />
        <Link
          href="/"
          className="relative z-[1] flex shrink-0 items-center rounded-lg px-0.5 py-0.5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#FF7A3D]/50 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent"

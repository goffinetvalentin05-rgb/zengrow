  ...
  return (
    ...
    >
      ...
      >
        ...
        <p className="fitme-lead">Entrez votre e-mail. Nous vous envoyons un lien de réinitialisation.</p>
        {success ? (
          <p className="fitme-note">Si un compte existe, un e-mail vient d’être envoyé. Pensez à vérifier vos spams.</p>
        ) : (

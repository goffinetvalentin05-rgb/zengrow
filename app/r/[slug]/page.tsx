    ...
    <>
      ...
      <main className="min-h-screen">
        <PublicReservationForm
          ...
          clientsChooseTable={safeSettings.floor_plan_clients_choose_table === true}
